            ...
            children: <Widget> [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget> [
                    Text(kelas, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold , fontSize: 13.0)),
                    Text(tersedia, style: TextStyle(fontWeight: FontWeight.bold , fontSize: 20),),
                  ],
                )
              ),
              Expanded(
