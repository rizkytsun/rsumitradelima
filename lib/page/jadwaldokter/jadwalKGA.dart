...
class JadwalKGA extends StatefulWidget {
  @override
  _JadwalKGAState createState() => _JadwalKGAState();
}

class _JadwalKGAState extends State<JadwalKGA> {
  @override
  void initState() {
    super.initState();
    getAPIaccess();
  ...
  Future getAPIaccess() async {
    final String url =
        'http://rsumitradelima.com:8080/api-rsmd/index.php/dokter?fungsi=5&kd_poli=kga';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        ...
        title: new Text('Poliklinik Spesialis KGA'),
      ),
