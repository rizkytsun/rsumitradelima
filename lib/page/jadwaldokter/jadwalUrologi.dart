...
void main() {
  runApp(new MaterialApp(
    title: "JadwalUrologi",
    home: new JadwalUrologi(),
  ));
}

class JadwalUrologi extends StatefulWidget {
  @override
  _JadwalUrologiState createState() => _JadwalUrologiState();
}

class _JadwalUrologiState extends State<JadwalUrologi> {
  @override
  void initState() {
    super.initState();
    getAPIaccess();
  ...
  Future getAPIaccess() async {
    final String url =
        'http://rsumitradelima.com:8080/api-rsmd/index.php/dokter?fungsi=5&kd_poli=ur';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        ...
        title: new Text('Poliklinik Spesialis Urologi'),
      ),
      backgroundColor: MyConstants().colorJadwalDR,
      body: isLoadingData
