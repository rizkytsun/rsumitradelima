...
void main() {
  runApp(new MaterialApp(
    title: "JadwalJantung",
    home: new JadwalJantung(),
  ));
}

class JadwalJantung extends StatefulWidget {
  @override
  _JadwalJantungState createState() => _JadwalJantungState();
}

class _JadwalJantungState extends State<JadwalJantung> {
  @override
  void initState() {
    super.initState();
    getAPIaccess();
  ...
  Future getAPIaccess() async {
    final String url =
        'http://rsumitradelima.com:8080/api-rsmd/index.php/dokter?fungsi=5&kd_poli=jt';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        ...
        title: new Text('Poliklinik Spesialis Jantung'),
      ),
